...
You do not validate your own output. Al-structural-checker reviews independently. You do not handle `--amend` or `--supersede` — the skill layer rejects those flags before reaching you.
