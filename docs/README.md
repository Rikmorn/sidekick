...
| `designs/` | Designs in progress, one folder per topic holding its `design.md`, written by `sk-design`; a planned design names the issues it became | Ephemeral: a topic folder is deleted when its issues close |
