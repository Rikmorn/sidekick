...
**Status (2026-06-18):** Architecture settled (ADR-0001/0002/0003/0004 — ADR-0004 *accepted 2026-06-18*: loop identity + redesign re-entry + the autonomy seam, implemented by `1.2`). Toolchain built and working (6 skills + 23 agents + 11 CLI helpers + tier-0 hook). **Phase 0 complete**; **Phase 1 — all items `1.1`–`1.6` done 2026-06-18; closes after the owed batched integration smokes.** **Re-baselined 2026-06-18** (foundations-then-memory: eval keystone pulled forward into Phase 3; memory consolidated into a dedicated Phase 4; Rules group dropped). Phases 2–5 unstarted. Live state snapshot: [`EPIC-STATE.md`](./EPIC-STATE.md).
