...
**Status:** In progress — **E1 + E2 + E19 + E23 done** (E1 2026-06-09 `3c5a340`; E2/ADR-0002 2026-06-10; E19 fan-out seam + pilot 2026-06-15; E23 sk-design two-mode rework 2026-06-15, commits `f8fe3f2..5d8a56d`); the rest unstarted. **Each item below is its own future planning session.** Tiers = priority; **IDs now ascend with intended execution order** (renumbered 2026-06-07). **Sources** link the research that justifies each item; **Deps** note prerequisites.
