...
2. **E19/E20/E21** (ADR-0002 follow-through: fan-out seam+pilot, tier-0 hooks base, instrumentation — small, unblocked, the pilot generates the data everything downstream calibrates on) **+ E3** (audit by role-group; includes the sk-build shrink) **+ E4/E5/E6** (rule codifications — now unblocked; E6 ships framing-first now, calibration after E8).
