import { type AssetProbe, probeAsset, renderThumbnail } from './media.js';
...
/** GET /assets/:id/thumbnail?size= — returns the path of the rendered file. */
export async function getAssetThumbnail(
  ...
  return renderThumbnail(asset.storagePath, req.query.size ?? '320x240');
}
